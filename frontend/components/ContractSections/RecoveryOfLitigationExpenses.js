...
export default function RecoveryOfLitigationExpenses(props) {
  return (
    <li>
      <h5>RECOVERY OF LITIGATION EXPENSES</h5>
      <ol>
        <li>
          <p>
            If any legal action, arbitration or other proceeding is necessary

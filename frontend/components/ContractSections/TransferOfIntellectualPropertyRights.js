...
export default function TransferOfIntellectualPropertyRights(props) {
  return (
    <li>
      <h5>TRANSFER OF INTELLECTUAL PROPERTY RIGHTS</h5>
      <ol>
        <li>
          <p>
            The Service Provider grants all IP rights to the Client upon final
            ...
            property rights associated with any ideas, concepts, inventions,
          ...
          <ul className="dotted-list">
            <li>
              <p>Google Ads Account, Campaign Setup and Strategy</p>
            </li>
            <li>
              <p>Facebook Ads Account, Campaign Setup and Strategy</p>
            </li>
          </ul>
        </li>
        <li>
          <p>
            The Service Provider shall maintain ownership to all rights,
            including, without limitation, copyrights, patents, trade secret
            rights, and other intellectual property rights associated with any
            ...
            non-exclusive, unlimited license to use the Work Product.
          </p>
        </li>
      </ol>
    </li>

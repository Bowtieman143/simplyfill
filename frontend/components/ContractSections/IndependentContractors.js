...
export default function IndependentContractors(props) {
  return (
    <li>
      ...
      <ol>
        <li>
          <p>
            The Service Provider agrees that all Services will be performed by
            the Service Provider as an independent contractor and that this
            Agreement does not create an employer-employee relationship between
            the Service Provider and the Client. The Service Provider shall have
            no right to receive any employee benefits provided by the Client to
